package  {
	...
	public class TrackingCamera {
		...
		public static function avg_points(points_arr : Array) : Point {
		...
		public static function group_points(points_arr : Array, thresh : Number ) {
		...
		public static function tightest_group(points_arr : Array, thresh : Number ) : Point {
